...
public:
    ...
    const std::shared_ptr<const std::vector<Matrix>> getPositions() const noexcept;
...
inline const std::shared_ptr<const std::vector<Matrix>> Piece::getPositions() const noexcept { 
    return _positions; 
}
